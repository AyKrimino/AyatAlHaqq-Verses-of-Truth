  ...
  return (
    <div className="flex justify-center">
      <div className="mt-2 px-4 sm:px-8 text-base sm:text-lg lg:text-xl max-w-3xl flex flex-col items-center justify-center">
        <h1 className="mb-2 font-english text-3xl font-bold">
          Welcome to AyatAlHaqq (Verses of Truth)
        </h1>
        <p className="font-arabic2 text-right" dir="rtl">
          ...
          والبقاء، كشجرة طيبة أصلها ثابت وفرعها في السَّماء، وذلك لأنه من عند
          الله الواحد القهار، الذي بيده الخَلْق والأمر، وهو سبحانه قد جعل هذا
          (القرآن) رسالته الخاتمة إلى البشرية، وتكفّل بحفظه إلى يوم الدين فقال:{" "}
